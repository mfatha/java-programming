...
public class WebScrapC360ReviewHandler extends WebScrapHandler {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(WebScrapC360ReviewHandler.class);
	...
	public void startProcess() {
		...
		fetchCSVFilesFromFolder(new File(WebSurfConstants.OUTPUT_FOLDER.concat("CollegesList_c360")), 1);
	}
